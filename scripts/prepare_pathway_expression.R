# Prepare Entrez-level expression for pathway analysis.
#!/usr/bin/env Rscript
...
if (nrow(representative) != expected_n) {
  stop_with(paste("Expected", expected_n, "Entrez IDs but obtained", nrow(representative), ". Check the HuEx annotation package version."))
}
